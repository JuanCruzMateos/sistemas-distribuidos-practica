...
export default function PokemonFavouriteForm({ onClose, onSubmit }: PokemonFavouriteFormProps) {
    const initialValues: PokemonFavouriteFormValues = {
        nickname: "",
        description: "",
    };

    const handleSubmit = (values: PokemonFavouriteFormValues) => {
        onSubmit(values.nickname, values.description);
        onClose?.();
    };
